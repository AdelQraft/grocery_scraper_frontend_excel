...
function waitUntilEnvironmentIsLoaded() {
  return _waitUntilEnvironmentIsLoaded.apply(this, arguments);
 ...
 */
function _waitUntilEnvironmentIsLoaded() {
  _waitUntilEnvironmentIsLoaded = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return (0,_utility__WEBPACK_IMPORTED_MODULE_1__.waitUntil)(function () {
            return !!_functions__WEBPACK_IMPORTED_MODULE_0__.Functions.instance.itemEndpointUrl;
          });
        case 2:
        case "end":
...
function getInfoFromUrl(url, refQuantity, refQuantityKind, massToCountRatio, massToVolumeRatio, infoToRetrieve, makePriceNegative, invocation) {
  waitUntilEnvironmentIsLoaded().then(function () {
