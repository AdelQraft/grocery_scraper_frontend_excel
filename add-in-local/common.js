...
var Environment = /*#__PURE__*/function () {
  ...
  return _createClass(Environment, null, [{
    key: "getInstancePromise",
    value: function () {
      var _getInstancePromise = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var _this = this;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 3;
              return axios__WEBPACK_IMPORTED_MODULE_0__["default"].get("/grocery_scraper_frontend_excel/add-in-local/env_def.json").then(function (resp) {
                _this._instance = new Environment(resp.data);
              });
            case 3:
              return _context.abrupt("return", Environment._instance);
            case 4:
            case "end":
      ...
      function getInstancePromise() {
        return _getInstancePromise.apply(this, arguments);
      }
      return getInstancePromise;
    }()
  }]);
}();
...
/* harmony export */ });
/* harmony import */ var _product_info__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./product_info */ "./src/function/product_info.ts");
...
var Functions = /*#__PURE__*/function () {
  ...
  */
  ...
  return _createClass(Functions, [{
    ...
    key: "getInfoFromUrl",
    value: function getInfoFromUrl(url, refQuantity, refQuantityKind, massToCountRatio, massToVolumeRatio, infoToRetrieve, makePriceNegative, invocation) {
      var hostname = new URL(url).hostname;
      if (hostname == null) {
        invocation.setResult(Functions._ExcelFunctionError.INVALID_VALUE);
        return;
      }
      var infoToRetrieveSplit;
      ...
      if (infoToRetrieve) {
        infoToRetrieveSplit = infoToRetrieve.split(",").map(function (value) {
          return value.trim();
        });
      } else {
        infoToRetrieveSplit = ["price-in-local-currency-slc", "protein-mass-g", "energy-Cal"];
      }
      var _iterator = _createForOfIteratorHelper(infoToRetrieveSplit),
        _step;
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var singleInfo = _step.value;
      ...
      (function callApi() {
        axios__WEBPACK_IMPORTED_MODULE_1__["default"].get(that._itemEndpointUrl + '?' + reqParams.toString(), {
          ...
          invocation.setResult([infoToRetrieveSplit.map(function (infoName) {
            var singleInfo = info.getQuantitativeProperty(infoName).valueOf();
...
var ProductInfo = /*#__PURE__*/function () {
  function ProductInfo(src) {
    _classCallCheck(this, ProductInfo);
    Object.assign(this, src);
  }
  return _createClass(ProductInfo, [{
    key: "getQuantitativeProperty",
    value: function getQuantitativeProperty(repr) {
      switch (repr) {
        case "price-in-local-currency-slc":
          return this.priceInLocalCurrency_slc;
        case "count-id":
        ...
        case "protein-mass-g":
          return this.proteinMass_g;
        case "energy-Cal":
          return this.energy_Cal;
        default:
          throw new Error("don't know how to parse \"".concat(repr, "\""));
      }
    }
  }]);
}();
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkgrocery_scraper_frontend_excel"] = self["webpackChunkgrocery_scraper_frontend_excel"] || [];
